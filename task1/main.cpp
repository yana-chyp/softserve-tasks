...
int main() {
    t_element*** const plist = (t_element***)malloc(sizeof(char**));
    ...
    for (auto elem = *plist; *elem!=nullptr; ++elem) std::cout<<*elem<<"\t"<<**elem<<"\n";
    ...
    // std::cout<<"index of 'drive' = "<<stringListIndexOf(*plist, "505")<<"\n";
